...
.bind_done:
    ...
    ; "blogd 0.8 listening on http://127.0.0.1:P (threads: N)\n"
    mov rdi, banner_buf
    mov rsi, [bind_msg]
...
msg_listen: db 'blogd 0.8 listening on http://127.0.0.1:'
msg_listen_len equ $-msg_listen
msg_listen_all: db 'blogd 0.8 listening on http://0.0.0.0:'
